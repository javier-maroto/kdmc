...
def parse_args():
    ...
    parser.add_argument('--dataset', default='cifar10', choices=['cifar10','cifar100','svhn','r-in','xor','moons'], help='Dataset used')
    parser.add_argument('--lr', default=0.1, type=float, help='Initial learning rate')
    parser.add_argument('--resume', '-r', action='store_true', help='resume from checkpoint')
    parser.add_argument('--arch', default='resnet18', choices=['resnet18', 'resnet50', 'pa-resnet18-swish', 'wrn-28-10-swish', 'toy'], help='Target model architecture')
    ...
    parser.add_argument('--atk', nargs="+", default=['pgd', 'Linf', '8/255', '2/255', '7'], type=str, help='Attack (name, **kwargs)')
